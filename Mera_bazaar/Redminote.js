...
import iphone from './json/Mobile_redmi_note_9.json';
            ...
            return <div className="card mb-3" style={{ "maxWidth": "540px",'border':'1px solid black'}}>
              <div className="row g-0">
                <div className="col-md-4">
                  ...
                  <img style={{'width':'200px','height':'200px'}} src={`.${e.image}`} className="img-fluid rounded-start" alt="..." />
                </div>
